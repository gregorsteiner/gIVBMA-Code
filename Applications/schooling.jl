...
density!(ax1, res_bric_2.Σ[2, 2, :], label = L"With parent edu. ($n = 2{,}215$)", color = :transparent, strokecolor = cols[2], strokewidth = wdth, linestyle = :dot)
density!(ax1, res_bric_1_small.Σ[2, 2, :], label = L"No parent edu. ($n = 2{,}215$)", color = :transparent, strokecolor = cols[3], strokewidth = wdth, linestyle = :dashdotdot)

ax2 = Axis(fig[1, 2], ylabel = "", title = "gIVBMA (hyper-g/n)")
density!(ax2, res_hg_1.Σ[2, 2, :], label = L"No parent edu. ($n = 3{,}003$)", color = :transparent, strokecolor = cols[1], strokewidth = wdth)
density!(ax2, res_hg_2.Σ[2, 2, :], label = L"With parent edu. ($n = 2{,}215$)", color = :transparent, strokecolor = cols[2], strokewidth = wdth, linestyle = :dot)
density!(ax2, res_hg_1_small.Σ[2, 2, :], label = L"No parent edu. ($n = 2{,}215$)", color = :transparent, strokecolor = cols[3], strokewidth = wdth, linestyle = :dashdotdot)

ax3 = Axis(fig[1, 3], ylabel = "", title = "IVBMA")
density!(ax3, res_ivbma_1.Σ[2, 2, :], label = L"No parent edu. ($n = 3{,}003$)", color = :transparent, strokecolor = cols[1], strokewidth = wdth)
density!(ax3, res_ivbma_2.Σ[2, 2, :], label = L"With parent edu. ($n = 2{,}215$)", color = :transparent, strokecolor = cols[2], strokewidth = wdth, linestyle = :dot)
density!(ax3, res_ivbma_1_small.Σ[2, 2, :], label = L"No parent edu. ($n = 2{,}215$)", color = :transparent, strokecolor = cols[3], strokewidth = wdth, linestyle = :dashdotdot)
